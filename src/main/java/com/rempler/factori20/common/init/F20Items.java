...
public class F20Items {
    ...
    public static final RegistryObject<ResearchItem> RESEARCH_3 = ITEMS.register("research_3_1",
            () -> new ResearchItem(TAB,3, 1));
    public static final RegistryObject<ResearchItem> RESEARCH_4 = ITEMS.register("research_4_1",
            () -> new ResearchItem(TAB,4, 1));
    public static final RegistryObject<ResearchItem> RESEARCH_5 = ITEMS.register("research_5_1",
            () -> new ResearchItem(TAB,5, 1));
    public static final RegistryObject<ResearchItem> RESEARCH_6 = ITEMS.register("research_6_1",
            () -> new ResearchItem(TAB,6,1));
    public static final RegistryObject<ResearchItem> RESEARCH_1_8 = ITEMS.register("research_1_8",
            () -> new ResearchItem(TAB,1, 8));
    public static final RegistryObject<ResearchItem> RESEARCH_2_8 = ITEMS.register("research_2_8",
            () -> new ResearchItem(TAB,2, 8));
    public static final RegistryObject<ResearchItem> RESEARCH_3_8 = ITEMS.register("research_3_8",
            () -> new ResearchItem(TAB,3, 8));
    public static final RegistryObject<ResearchItem> RESEARCH_4_8 = ITEMS.register("research_4_8",
            () -> new ResearchItem(TAB,4, 8));
    public static final RegistryObject<ResearchItem> RESEARCH_5_8 = ITEMS.register("research_5_8",
            () -> new ResearchItem(TAB,5, 8));
    public static final RegistryObject<ResearchItem> RESEARCH_6_8 = ITEMS.register("research_6_8",
            () -> new ResearchItem(TAB,6,8));
    public static final RegistryObject<ResearchItem> RESEARCH_1_64 = ITEMS.register("research_1_64",
            () -> new ResearchItem(TAB,1, 64));
    public static final RegistryObject<ResearchItem> RESEARCH_2_64 = ITEMS.register("research_2_64",
            () -> new ResearchItem(TAB,2, 64));
    public static final RegistryObject<ResearchItem> RESEARCH_3_64 = ITEMS.register("research_3_64",
            () -> new ResearchItem(TAB,3, 64));
    public static final RegistryObject<ResearchItem> RESEARCH_4_64 = ITEMS.register("research_4_64",
            () -> new ResearchItem(TAB,4, 64));
    public static final RegistryObject<ResearchItem> RESEARCH_5_64 = ITEMS.register("research_5_64",
            () -> new ResearchItem(TAB,5, 64));
    public static final RegistryObject<ResearchItem> RESEARCH_6_64 = ITEMS.register("research_6_64",
            () -> new ResearchItem(TAB,6,64));
    public static final RegistryObject<ScannerItem> SCANNER = ITEMS.register("scanner",
            () -> new ScannerItem(TAB));
    public static final RegistryObject<WIPItem> ADV_SCANNER = ITEMS.register("advanced_scanner",
            () -> new WIPItem(TAB));
