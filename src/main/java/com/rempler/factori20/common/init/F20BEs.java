...
public class F20BEs {
    ...
    public static final RegistryObject<BlockEntityType<ElectricResearchBlockEntity>> ELECTRIC_RESEARCH = BLOCK_ENTITIES.register("electric_research_block_entity",
            () -> BlockEntityType.Builder.of(ElectricResearchBlockEntity::new, F20Blocks.ELECTRIC_RESEARCH_BLOCK.get()).build(null));
    public static final RegistryObject<BlockEntityType<BurnerResearchBlockEntity>> BURNER_RESEARCH = BLOCK_ENTITIES.register("burner_research_block_entity",
