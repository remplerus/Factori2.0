...
public abstract class AbstractResearchScreen<T extends BaseResearchContainerMenu> extends AbstractContainerScreen<T> {
    protected static ResourceLocation BACKGROUND_TEXTURE;

    public AbstractResearchScreen(T pMenu, Inventory pPlayerInventory, Component pTitle) {
